...
- This version forces a rebuild of every world actor and unlinked token from its stored HDC data. Actors with no stored HDC are flagged "REQUIRES HDC UPLOAD" until their .hdc file is uploaded again.
...
[#4603](https://github.com/dmdorman/hero6e-foundryvtt/issues/4603) [#4689](https://github.com/dmdorman/hero6e-foundryvtt/issues/4689)
  - Per-Phase start and end work runs in the tracker: continuing charges, effect fades, upkeep cards, and post-Segment 12 recoveries. Post-12 recoveries print on one combined card and NPC recoveries are GM-only. [#4565](https://github.com/dmdorman/hero6e-foundryvtt/issues/4565) [#4567](https://github.com/dmdorman/hero6e-foundryvtt/issues/4567)
[#4559](https://github.com/dmdorman/hero6e-foundryvtt/issues/4559) [#4554](https://github.com/dmdorman/hero6e-foundryvtt/issues/4554) [#4526](https://github.com/dmdorman/hero6e-foundryvtt/issues/4526) [#2419](https://github.com/dmdorman/hero6e-foundryvtt/issues/2419)
  ...
  - Per-Turn DEX tie rolls, Fast Draw tie-breaks, and Lightning Reflexes stops that survive rewinds.
  - Combatant grouping improvements: per-segment shuffle inside groups, "Split All from Group" and "Rejoin All to Group" context options, and a new "Group Same-Actor Combatants" world setting to disable grouping entirely.
  - New "Compact Combat Tracker" option. Encumbered shows as a condition, invisible tokens are hidden automatically, and condition icons are prioritized, grouped, and capped at four per row. [#2319](https://github.com/dmdorman/hero6e-foundryvtt/issues/2319) [#4466](https://github.com/dmdorman/hero6e-foundryvtt/issues/4466)
[#3157](https://github.com/dmdorman/hero6e-foundryvtt/issues/3157) [#3280](https://github.com/dmdorman/hero6e-foundryvtt/issues/3280)
  - Clicking a combatant switches to its scene level before panning, portrait flicker is fixed, and light mode is readable. [#4677](https://github.com/dmdorman/hero6e-foundryvtt/issues/4677) [#4667](https://github.com/dmdorman/hero6e-foundryvtt/issues/4667)
...
- Folder drops onto the actor sheet keep each item's own type instead of retyping by tab. Dropping into attacks/defenses/maneuvers also works. [#4731](https://github.com/dmdorman/hero6e-foundryvtt/issues/4731)
...
- To-hit rolls show an explicit 0 OCV in formulas and tags. [#4741](https://github.com/dmdorman/hero6e-foundryvtt/issues/4741)
...
- Halved conditions no longer stack. Only the most severe halving per characteristic applies, while x1+ multipliers still stack. [#3467](https://github.com/dmdorman/hero6e-foundryvtt/issues/3467) [#3125](https://github.com/dmdorman/hero6e-foundryvtt/issues/3125) [#1342](https://github.com/dmdorman/hero6e-foundryvtt/issues/1342)
[#3158](https://github.com/dmdorman/hero6e-foundryvtt/issues/3158) [#3218](https://github.com/dmdorman/hero6e-foundryvtt/issues/3218)
- Fixed Flash and drain fades that stalled, fade timing, and a healing crash. [#4524](https://github.com/dmdorman/hero6e-foundryvtt/issues/4524) [#4564](https://github.com/dmdorman/hero6e-foundryvtt/issues/4564) [#4280](https://github.com/dmdorman/hero6e-foundryvtt/issues/4280)
- Natural BODY healing works while other effects are disabled or suppressed. Uploads and item edits no longer create duplicate active effects.
...
- Adjustment target pickers no longer list frameworks or compound powers. [#4729](https://github.com/dmdorman/hero6e-foundryvtt/issues/4729)
- Compendium items with Requires A Roll open without crashing, and an unnamed RSR skill gives a clear warning. [#4734](https://github.com/dmdorman/hero6e-foundryvtt/issues/4734) [#4735](https://github.com/dmdorman/hero6e-foundryvtt/issues/4735)
...
- Entangles show their status icon properly. [#4460](https://github.com/dmdorman/hero6e-foundryvtt/issues/4460)
